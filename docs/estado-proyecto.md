...
- **Próximo:** push del Sprint 15 a producción (tras `db push` del usuario) → Sprint 16 (ciudad/provincia, especialidades, REFES, mensaje de clínica) → 17 (ingesta Gmail; OAuth ya listo). Backlog: aceptación de invitaciones; temas para la consulta; cerrar/limitar registro público (decisión del usuario pendiente).
